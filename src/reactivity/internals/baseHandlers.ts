 ...
 */
const mutableGet: ProxyHandler<Record<PropertyKey, unknown>>['get'] = function getReactiveValue(
  target,
  key,
  receiver,
) {
 ...
 */
const mutableSet: ProxyHandler<Record<PropertyKey, unknown>>['set'] = function setReactiveValue(
  target,
  key,
  value,
  receiver,
